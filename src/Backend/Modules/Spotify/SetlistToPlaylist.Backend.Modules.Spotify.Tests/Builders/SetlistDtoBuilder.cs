...
internal sealed class SetlistDtoBuilder
{
    ...
    private string _url = "https://www.setlist.fm/setlist/radiohead/63eb7e6b.html";
    private SongDto[] _songs = [];

    public SetlistDtoBuilder WithArtist(string name) { _artistName = name; return this; }
    public SetlistDtoBuilder WithUrl(string url) { _url = url; return this; }
    ...
    {
        Artist = new SetlistFm.Abstractions.DTOs.ArtistDto { Name = _artistName },
